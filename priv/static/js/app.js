...
require.register("web/static/components/my-app.vue", function(exports, require, module) {
;(function(){
"use strict";
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"my-app"},[_c('h1',[_vm._v("Online now")]),_vm._v(" "),_c('table',_vm._l((_vm.whos),function(who){return _c('tr',[_c('td',[_vm._v(_vm._s(who.name))]),_vm._v(" "),_c('td',[_vm._v(_vm._s(who.hostname))]),_vm._v(" "),_c('td',[_vm._v(_vm._s(who.tty))])])}))])}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2bab54be", __vue__options__)
  } else {
    hotAPI.reload("data-v-2bab54be", __vue__options__)
  }
})()}
});
...
var _myApp = require("../components/my-app.vue");
...
_vue2.default.component('my-app', _myApp2.default);
...
window.addEventListener('load', function () {
	new _vue2.default({
		...
		mounted: function mounted() {
			...
			this.channel.on("new_message", function (payload) {
				_this.whos = payload['whos'];
				console.log(_this.whos);
			});
			this.channel.join().receive("ok", function (response) {
				console.log("Joined successfully", response);
				_this.channel.push("send_data", {});
		...
		render: function render(createElement) {
			return createElement(_myApp2.default, {});
		}
	});
});
